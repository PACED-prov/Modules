...
def main(filepath, host_ipcns, cns_json_path):
...
if __name__ == '__main__':
    try:
        if len(sys.argv) != 4:
            raise Exception("run python3 csv_generator.py <filepath> <host_ipcns> <cns_json_path>")
        else:
            print("Starting...")
            print("Filepath:", sys.argv[1])
            print("Host IPCNS:", sys.argv[2])
            print("CNS Json Path:", sys.argv[3])
